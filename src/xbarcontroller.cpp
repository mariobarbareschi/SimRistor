...
simristor::XBarController::XBarController(XBar* crossbar, int inputRow, int inputs, int minterms, int outputs){
...
simristor::XBarController* simristor::XBarController::ina(){
...
simristor::XBarController* simristor::XBarController::ri(bool* inputValues){
    DEBUG(clock_t begin = clock());
    int j;
    for(j = 0; j < 2*inputs; j++)
...
simristor::XBarController* simristor::XBarController::cfm(){
    DEBUG(clock_t begin = clock());
    int j, i;
...
simristor::XBarController* simristor::XBarController::evm(){
    DEBUG(clock_t begin = clock());
    int j, i;
    for(i = 0; i < minterms; i++){
        int colIndex = 0;
...
simristor::XBarController* simristor::XBarController::evr(){
    DEBUG(clock_t begin = clock());
    int j, i;
    for(i = 0; i < outputs; i++){
        j = 0;
...
simristor::XBarController* simristor::XBarController::inr(){
    DEBUG(clock_t begin = clock());
    int j, i;
    for(i = 0; i < outputs; i++){
...
simristor::XBarController* simristor::XBarController::so(bool* outputValues){
    DEBUG(clock_t begin = clock());
    int i;
    for(i = 0; i < outputs; i++)
...
const simristor::XBar* simristor::XBarController::getXBar() const{
    return crossbar;
}


void simristor::XBarController::print(std::ostream& outstream){
...
simristor::XBarController::~XBarController(){
    delete MInput;
    delete MMinterm;
    delete MOutput;
